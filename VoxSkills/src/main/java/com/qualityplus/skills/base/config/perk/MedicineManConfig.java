...
public final class MedicineManConfig extends OkaeriConfig implements PerkFile {
    ...
    public double healPercentageToRegeneratePerLevel = 0.1;
    public double healPercentageToRegenerateBase = 0;
    ...
    public Perk getPerk() {
        return MedicineManPerk.builder()
                ...
                .healPercentageToRegeneratePerLevel(healPercentageToRegeneratePerLevel)
                .healPercentageToRegenerateBase(healPercentageToRegenerateBase)
                .build();
    }
}
