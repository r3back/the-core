...
public final class ProjectileMasterConfig extends OkaeriConfig implements PerkFile {
    ...
    public int extraDamagePercentageBase = 0;
    public int extraDamagePercentageBasePerLevel = 1;
    ...
    public Perk getPerk() {
        return ProjectileMasterPerk.builder()
                ...
                .extraDamagePercentageBase(extraDamagePercentageBase)
                .extraDamagePercentageBasePerLevel(extraDamagePercentageBasePerLevel)
                .build();
    }
}
