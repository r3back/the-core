...
@Component
public final class RemovePerkCommand extends AssistantCommand {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        if (args.length == 4) {
            ...
            final CommonObject object = Perks.getByID(args[2]);
    ...
    public void register(@Inject Box box) {
        TheAssistantPlugin.getAPI().getCommandProvider().registerCommand(this, e -> e.getCommand().setDetails(box.files().commands().removePerkCommand));
    }
}
