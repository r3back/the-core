...
public final class BrewerChanceConfig extends OkaeriConfig implements PerkFile {
    ...
    public GUIOptions guiOptions = GUIOptions.builder()
            ...
            .build();
    public double chancePerLevel = 1;
    public int secondsDurationPerLevel = 1;
    public int baseSecondsDuration = 1;
    ...
    public Perk getPerk() {
        return BrewChancePerk.builder()
                ...
                .secondsDurationPerLevel(secondsDurationPerLevel)
                .baseSecondsDuration(baseSecondsDuration)
