...
public final class StatsAndPerksGUI extends SkillsGUI {
    ...
    public @NotNull Inventory getInventory() {
        ...
        if (this.type.equals(GUIType.STAT)) {
            ...
            for (final Stat stat : Stats.values(CommonObject::isEnabled)) {
                ...
                this.inventory.setItem(options.getSlot(), SkillsItemStackUtil.makeItem(this.config.statItem, Arrays.asList(
            ...
            for (final Perk perk : Perks.values(CommonObject::isEnabled)) {
                ...
                this.inventory.setItem(options.getSlot(), SkillsItemStackUtil.makeItem(this.config.perkItem, Arrays.asList(
