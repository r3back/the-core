...
public final class GameEventSwitchImpl implements GameEventSwitch {
    ...
    public void switchEvents() {
        ...
        TheDragonEntity dragon = VoxDragon.getApi().getDragonService().getActiveDragon();
        ...
        eventTask = Bukkit.getScheduler().scheduleAsyncRepeatingTask(VoxDragon.getApi().getPlugin(), () -> {
            ...
            if (switchableEvent.getCurrentEvent() == null || !switchableEvent.getCurrentEvent().isActive()) {
                ...
                Optional.ofNullable(switchableEvent.getNext())
                        .ifPresent(nextEvent -> {
                            ...
                            VoxDragon.getApi().getUserService().sendMessage(Collections.singletonList(message));
                        });
            }
        }, 0, 20);
    }
