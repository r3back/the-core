...
import com.qualityplus.dragon.api.VoxDragonAPI;
...
public final class GameRankingImpl implements GameRanking {
    ...
    public void refreshRanking() {
        final VoxDragonAPI api = VoxDragon.getApi();
    ...
    private String getLastAttacker() {
        return Optional.ofNullable(VoxDragon.getApi().getUserService().getLast())
    ...
    private double getDragonXp() {
        return Optional.ofNullable(VoxDragon.getApi().getDragonService().getActiveDragon())
