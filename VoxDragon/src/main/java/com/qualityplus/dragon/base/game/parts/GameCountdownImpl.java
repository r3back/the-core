...
public final class GameCountdownImpl implements GameCountdown {
    ...
    public CompletableFuture<Void> start(final TheDragonEntity theDragonEntity) {
        ...
        final Optional<DragonSpawn> spawn = VoxDragon.getApi().getStructureService().getSpawn();
        ...
        this.taskID = Bukkit.getScheduler().scheduleSyncRepeatingTask(VoxDragon.getApi().getPlugin(), () -> {
