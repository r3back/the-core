...
public class VanillaEnchantLegacy extends CoreEnchantLegacy {
    ...
    public VanillaEnchantLegacy(@NotNull String identifier, Integer id, Map<Integer, String> requiredPermissionsToEnchant, Map<Integer, Double> requiredXpLevelToEnchant, int maxLevel, boolean enabled, int requiredBookShelf,
        ...
        super(identifier, id, requiredPermissionsToEnchant, requiredXpLevelToEnchant, maxLevel, enabled, requiredBookShelf, requiredMoneyToEnchant, displayName, description, providerType);
