...
import com.qualityplus.collections.listener.minions.VoxMinionsListener;
...
public final class MinionsRegistry {
    ...
    private static final String THE_MINIONS_PLUGIN_NAME = "VoxMinions";
    ...
    public void configureMinions() {
        ...
        if (resolver.isPlugin(THE_MINIONS_PLUGIN_NAME)) {
            sendMinionsMessage();
            Bukkit.getPluginManager().registerEvents(injector.createInstance(VoxMinionsListener.class), plugin);
        }
    }
