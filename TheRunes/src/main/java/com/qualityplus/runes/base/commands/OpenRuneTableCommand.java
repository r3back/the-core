...
@Component
public final class OpenRuneTableCommand extends AssistantCommand {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        return openInventory(args, sender, new RuneTableGUI(box, new RuneSessionImpl(player.getUniqueId(), null, null, null, null)), syntaxMsg, mustBeAPlayer, invalidPlayer);
    }
