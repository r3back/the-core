...
public final class EcoHookSettings implements EcoWarning {
    ...
    public void sendWarning() {
        ...
        boolean addDescriptionsFromVoxEnchanting = config.enchantmentsDisplay.displayEnchantmentsInLore;
        ...
        if (addDescriptionsFromEcoEnchants && addDescriptionsFromVoxEnchanting) {
            logger.warning("Enchantments descriptions in lore are enabled in EcoEnchants and VoxEnchanting!");
            logger.warning("This will produce bugs with item's lore please disable it in VoxEnchanting or in EcoEnchants and start server again!");

            //Bukkit.getServer().getPluginManager().disablePlugin(plugin);
        } else {
            String using = addDescriptionsFromEcoEnchants ? "EcoEnchants" : "VoxEnchanting";
