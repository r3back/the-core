...
public final class EnchantmentChainImpl implements EnchantmentChain {
    ...
    public ItemStack addEnchantment(ItemStack itemStack, EnchantmentSession session) {
        Optional<ICoreEnchantment> incompatibility = VoxEnchanting.getApi().getIncompatibility(itemStack, session.getEnchantment());

        Map<ICoreEnchantment, Integer> enchantmentList = VoxEnchanting.getApi().getEnchantments(itemStack);
