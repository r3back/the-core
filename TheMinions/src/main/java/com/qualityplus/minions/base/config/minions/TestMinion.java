...
@Getter
@Configuration(path = "minions/test_minion.yml")
@Header("================================")
@Header("       Test Minion      ")
@Header("")
@Header("This file is just for test purposes")
@Header("and also is an example of how to configure")
@Header("item upgrades.")
@Header("================================")
@Names(strategy = NameStrategy.HYPHEN_CASE, modifier = NameModifier.TO_LOWER_CASE)
public final class TestMinion extends OkaeriConfig {
    private final String id = "test_minion";
    private final String displayName = "Test Minion";
            ...
            .upgradeSettings(FastMap.builder(String.class, UpgradeSettings.class)
                    .put("super_compactor_6000", UpgradeSettings.builder()
                            ...
                            .itemSettings(ItemSettings.builder()
                                    .itemsToGive(Collections.singletonList(ItemBuilder.of(XMaterial.DIAMOND_BLOCK, 1, "&8Epic Diamond Block", Arrays.asList("", "&9&dEPIC"))
                                                    .enchanted(true)
                                                    .buildStack()))
