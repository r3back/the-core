...
public final class DatabaseFactory extends HikariConfiguration {
    ...
    public DocumentPersistence configurePersistence(@Inject("dataFolder") final File dataFolder, @Inject final Config config) {
        ...
        final PersistencePath basePath = PersistencePath.of("skills_db");
        ...
        switch (backend) {
            ...
            /*case MONGODB:
                ...
                return new DocumentPersistence(new MongoPersistence(basePath, mongoClient, clientURI.
                getDatabase()), JsonSimpleConfigurer::new, new SerdesBukkit());
            */
            default:
