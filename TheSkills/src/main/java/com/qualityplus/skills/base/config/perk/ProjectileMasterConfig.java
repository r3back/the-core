...
/**
 * Utility class for projectile master config
 */
@Getter
@Setter
...
public final class ProjectileMasterConfig extends OkaeriConfig implements PerkFile {
    private String id = "projectile_master";
    private boolean enabled = true;
    private String displayName = "Projectile Master";
    private List<String> description = Collections.singletonList("&a%percent%% &7chance to make your projectiles &a%pr" +
            "ojectile_percent%% &7more stronger.");
     ...
     * Adds a perk
     *
     * @return {@link ProjectileMasterPerk}
     */
    public Perk getPerk() {
