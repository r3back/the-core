...
public final class SerdesSeaFortune implements ObjectSerializer<SeaFortunePerk> {
    ...
    @Override
    public boolean supports(@NonNull Class<? super SeaFortunePerk> type) {
        return SeaFortunePerk.class.isAssignableFrom(type);
    }

    @Override
    public void serialize(@NonNull SeaFortunePerk object, @NonNull SerializationData data, @NonNull GenericsDeclaration generics) {
    ...
    @Override
    public SeaFortunePerk deserialize(@NonNull DeserializationData data, @NonNull GenericsDeclaration generics) {
        SeaFortunePerk alchemySkill = new SeaFortunePerk();
