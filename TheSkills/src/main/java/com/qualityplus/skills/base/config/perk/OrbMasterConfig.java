...
/**
 * Utility class for orb master config
 */
@Getter
@Setter
...
public final class OrbMasterConfig extends OkaeriConfig implements PerkFile {
    private String id = "orb_master";
    private boolean enabled = true;
    private String displayName = "Orb Master";
    private List<String> description = Arrays.asList("  &a%percent%% &7chance to get double", "  &7experience orbs.");
    ...
    private GUIOptions guiOptions = GUIOptions.builder()
            ...
            .texture("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmU" +
                    "vYWMzYTRiNTFhNDgwMDI4OTBmYjI3MWNkYzE1MTdlYWY0MWFiMDAyNTNjMWI3ZDgyNDI3MjczNmJiNDE2NjNkNSJ9fX0=")
