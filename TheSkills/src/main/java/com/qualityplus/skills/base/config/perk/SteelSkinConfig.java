...
@Configuration(path = "perks/steel_skin.yml", serdes = SerdesSkillsRegistry.class)
@Header("================================")
@Header("       Steel Skin Perk      ")
@Header("================================")
@Names(strategy = NameStrategy.HYPHEN_CASE, modifier = NameModifier.TO_LOWER_CASE)
public final class SteelSkinConfig extends OkaeriConfig {
    public SteelSkinPerk steelSkinPerk = SteelSkinPerk.builder()
                                       .id("steel_skin")
                                       .displayName("Steel Skin")
                                       .description(Arrays.asList("  &a%percent%% &7chance to reduce fire damage."))
                                       .enabled(true)
