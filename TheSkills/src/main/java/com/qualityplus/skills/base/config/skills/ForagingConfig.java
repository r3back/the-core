...
/**
 * Utility class for foraging config
 */
@Getter
@Setter
...
public final class ForagingConfig extends OkaeriConfig {
    private String id = "foraging";
    private boolean enabled = true;
    private String displayName = "Foraging";
    private List<String> description = Collections.singletonList("&7Cut wood to earn foraging xp!");
    ...
    private GUIOptions guiOptions = GUIOptions.builder()
            ...
            .texture("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNWY0OTc" +
                    "3ODZkN2JhMTkyMzY5OTMyOTY2Njg2YWE5ZmI3MTQ3ZmE1ODg0ZjlhNjIwOWM0YTczZTJkNjBmMzlmNSJ9fX0=")
    ...
    private Map<Integer, List<StatReward>> getInternalRewards() {
        return FastMap.listBuilder(Integer.class, StatReward.class)
                .put(1, Arrays.asList(new StatReward("strength", 1), new StatReward("defense", 1),
                        new StatReward("foraging_fortune", 1), new StatReward("medicine_man", 1)))
                .put(10, Arrays.asList(new StatReward("strength", 2), new StatReward("defense", 2),
                        new StatReward("foraging_fortune", 1), new StatReward("medicine_man", 1)))
                .build();
    }
