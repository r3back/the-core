...
public final class SerdesWizard implements ObjectSerializer<WizardPerk> {
    ...
    @Override
    public boolean supports(@NonNull Class<? super WizardPerk> type) {
        return WizardPerk.class.isAssignableFrom(type);
    }


    @Override
    public void serialize(@NonNull WizardPerk object, @NonNull SerializationData data, @NonNull GenericsDeclaration generics) {
    ...
    @Override
    public WizardPerk deserialize(@NonNull DeserializationData data, @NonNull GenericsDeclaration generics) {
        WizardPerk alchemySkill = new WizardPerk();
