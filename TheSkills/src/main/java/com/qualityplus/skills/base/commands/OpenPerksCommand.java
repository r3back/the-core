...
/**
 * Utility class for open perks command
 */
@Component
public final class OpenPerksCommand extends AssistantCommand {
    ...
    public void register(@Inject final Box box) {
        TheAssistantPlugin.getAPI().getCommandProvider().registerCommand(this, e -> e.getCommand().setDetails(box.files().commands().getPerksCommand()));
    }
}
