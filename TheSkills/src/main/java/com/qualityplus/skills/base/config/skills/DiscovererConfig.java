...
/**
 * Utility class for discover config
 */
@Getter
@Setter
...
public final class DiscovererConfig extends OkaeriConfig {
    private String id = "discoverer";
    private boolean enabled = true;
    private String displayName = "Discoverer";
    private List<String> description = Collections.singletonList("&7Earn xp discovering the world!");
    ...
    private GUIOptions guiOptions = GUIOptions.builder()
            ...
            .texture("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYzY5MTk2" +
                    "YjMzMGM2Yjg5NjJmMjNhZDU2MjdmYjZlY2NlNDcyZWFmNWM5ZDQ0Zjc5MWY2NzA5YzdkMGY0ZGVjZSJ9fX0=")
    ...
    private Map<Integer, List<StatReward>> getInternalRewards() {
        return FastMap.listBuilder(Integer.class, StatReward.class)
                .put(1, Arrays.asList(new StatReward("speed", 1), new StatReward("ferocity", 1),
                        new StatReward("leaves_master", 1), new StatReward("cactus_skin", 1)))
                .put(10, Arrays.asList(new StatReward("speed", 2), new StatReward("ferocity", 2),
                        new StatReward("leaves_master", 1), new StatReward("cactus_skin", 1)))
                .build();
    }
