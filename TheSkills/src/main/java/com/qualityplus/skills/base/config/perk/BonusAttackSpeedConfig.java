...
/**
 * Utility class for Bonus attack speed config
 */
@Getter
@Setter
...
public final class BonusAttackSpeedConfig extends OkaeriConfig implements PerkFile {
    ...
    private String id = "bonus_attack_speed";
    private boolean enabled = true;
    private String displayName = "Bonus Attack Speed";
    private List<String> description = Collections.singletonList("&aSoon...");
    private int maxLevel = 50;
    private GUIOptions guiOptions = GUIOptions.builder()
            .slot(19)
            .item(XMaterial.PLAYER_HEAD)
            .texture("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleH" +
                    "R1cmUvNzQ5MmNhOTQwNzkxMzZkMjUyNTcwM2QzNzVjMjU1N2VhYzIwMWVlN2RkMzljZTExYzY0YTljMzgxNDdlY2M0ZCJ9fX0=")
     ...
     * Adds a perk
     *
     * @return {@link BonusAttackSpeedPerk}
     */
    public Perk getPerk() {
