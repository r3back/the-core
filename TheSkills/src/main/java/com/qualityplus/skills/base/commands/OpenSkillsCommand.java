...
/**
 * Utility class for open skills command
 */
@Component
public final class OpenSkillsCommand extends AssistantCommand {
    ...
    public boolean execute(final CommandSender sender, final String[] args) {
        ...
        return openInventory(args, sender, new MainGUI(this.box, player), syntaxMsg, mustBeAPlayer, invalidPlayer);
    }
    ...
    public void register(@Inject final Box box) {
        TheAssistantPlugin.getAPI().getCommandProvider().registerCommand(this, e -> e.getCommand().setDetails(box.files().commands().getMainMenuCommand()));
    }
}
