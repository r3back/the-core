...
public final class DungeoneeringConfig extends OkaeriConfig {
    ...
    private String id = "dungeoneering";
    private boolean enabled = true;
    private String displayName = "Dungeoneering";
    private List<String> description = Collections.singletonList("&7Earn xp by killing bosses!");
    ...
    private GUIOptions guiOptions = GUIOptions.builder()
            ...
            .texture("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMjA" +
                    "1MGRlNTcyY2Y4YmYxNDk2YjUyNzg1YWQzNDlkMDJhY2RkYTY0NDc5YjFiZTc1MDkzZTlhMWY3OTI4ZGQyIn19fQ=")
     ...
     * Adds a skill
     *
     * @return {@link DungeoneeringSkill}
     */
    public Skill getSkill() {
        return DungeoneeringSkill.builder()
                ...
                .mythicMobRewards(new HashMap<String, Double>() { { put("mythicMobIdExample", 10D); put("mythicMobIdExample2", 20D); }}).build();
    }
