...
@Component
public final class GivePersonalBankCommand extends AssistantCommand {
    ...
    public void register(@Inject Box box) {
        TheAssistantPlugin.getAPI().getCommandProvider().registerCommand(this, e -> e.getCommand().setDetails(box.files().commands().givePersonalBankCommand));
    }

    private ItemStack getItem() {
        NBTItem nbtItem = new NBTItem(ItemStackUtils.makeItem(box.files().config().personalBankItem));
        nbtItem.setBoolean("personalBank", true);
