...
@Scan(deep = true)
public final class VoxMinions extends OkaeriSilentPlugin {
    @Inject @Getter
    private static VoxMinionsAPI api;
    private static VoxMinions INSTANCE;

    public static VoxMinions getInstance() {
        return INSTANCE;
    }
