...
public final class SecondUpgradeItemSetup implements ItemSetup {
    ...
    public void setItem(Inventory inventory, Box box, MainMinionGUIConfig config, MinionEntity minionEntity) {
        Optional<MinionData> minionData = VoxMinions.getApi().getMinionsService().getData(minionEntity.getMinionUniqueId());
        ...
        if (upgradeEntity == null)
            ...
            inventory.setItem(config.getSecondUpgradePlacedItem().getSlot(), ItemStackUtils.makeItem(
