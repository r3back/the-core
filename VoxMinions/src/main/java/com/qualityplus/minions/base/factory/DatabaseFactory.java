...
public final class DatabaseFactory extends HikariConfiguration {
    ...
    public DocumentPersistence configurePersistence(@Inject("dataFolder") File dataFolder, @Inject Config config) {
        ...
        String h2Uri = "jdbc:h2:file:./plugins/VoxMinions/storage/storage;MODE=MYSQL;DATABASE_TO_LOWER=TRUE";
        ...
        switch (backend) {
            ...
            case H2:
                return new DocumentPersistence(new H2Persistence(basePath, getH2Hikari("VoxMinions")), JsonSimpleConfigurer::new, new SerdesBukkit());
            case REDIS:
