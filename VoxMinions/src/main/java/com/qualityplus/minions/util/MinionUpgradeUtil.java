...
public class MinionUpgradeUtil {
    ...
    private static final String FUEL_REMAINING_SECONDS = "THE_MINIONS_REMAINING_SECONDS";
    ...
    public ItemStack addFuelTags(
        ...
        nbtItem.setInteger(FUEL_REMAINING_SECONDS, remainingSeconds);
    ...
    public FuelEntity getFuelFromItem(ItemStack itemStack) {
        ...
        int remainingSeconds = nbtItem.getInteger(FUEL_REMAINING_SECONDS);
