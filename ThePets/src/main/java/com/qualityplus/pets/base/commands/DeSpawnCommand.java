...
@Component
public final class DeSpawnCommand extends AssistantCommand {
    ...
    public void register(@Inject Box box){
        TheAssistantPlugin.getAPI().getCommandProvider().registerCommand(this, e -> e.getCommand().setDetails(box.files().commands().deSpawnCommand));
    }
}