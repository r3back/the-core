...
public final class Inventories extends OkaeriConfig implements DefaultBackgrounds {
    ...
    public PetsGUIConfig mainGUIConfig = new PetsGUIConfig(
            ...
            ItemBuilder.of(XMaterial.STONE, 1, "&a%pet_gui_item_displayname% %pet_level%", Arrays.asList("",
                    "&7%pet_gui_item_description%",
                    "",
            ...
            ItemBuilder.of(XMaterial.STONE_BUTTON,  51, 1, "&aHide Pets", Arrays.asList(
                    ...
                    "&7world.", "", "&7Pets effects remain active.",
                    "",
                    "&7Currently: &aPets shown!",
                    "&7Selected Pet: %pet_selected_pet%",
                    "",
                    "&eClick to hide!")).build(),
            ItemBuilder.of(XMaterial.BONE,  4, 1, "&aPets", Arrays.asList("", "&e» &7Click to view specific stats.")).build()
