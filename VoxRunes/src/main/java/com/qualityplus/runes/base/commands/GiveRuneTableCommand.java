...
@Component
public final class GiveRuneTableCommand extends AssistantCommand {
    ...
    public void register(@Inject Box box) {
        TheAssistantPlugin.getAPI().getCommandProvider().registerCommand(this, e -> e.getCommand().setDetails(box.files().commands().giveRuneTableCommand));
    }

    private ItemStack getItem() {
        NBTItem nbtItem = new NBTItem(ItemStackUtils.makeItem(box.files().config().runeTableItem));
        nbtItem.setBoolean("runeTableItem", true);
