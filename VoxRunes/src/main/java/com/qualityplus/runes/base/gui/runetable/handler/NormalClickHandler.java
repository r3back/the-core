...
public final class NormalClickHandler implements ClickHandler {
    ...
    public void handle(InventoryClickEvent event) {
        ...
        final RuneTableGUIConfig cfg = gui.getConfig();

        if (slot == cfg.getClickToCombineRunesItem().getSlot() || slot == cfg.getClickToCombineItemAndRuneItem().getSlot()) {
        ...
        } else if (slot == cfg.getCombinedFilledItem().getSlot()) {
