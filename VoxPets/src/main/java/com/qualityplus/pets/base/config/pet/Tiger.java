    ...
    private Map<Integer, PetLevel> getPetLevelsMap() {
        return FastMap.builder(Integer.class, PetLevel.class)
                .put(1, PetLevel.builder()
                        ...
                        .commandsWhenSpawn(List.of(new CommandReward(CommandReward.CommandExecutor.CONSOLE, "give %player% oak_log")))
                        .commandWhenDeSpawn(List.of(new CommandReward(CommandReward.CommandExecutor.CONSOLE, "give %player% oak_log")))
                        .build())
