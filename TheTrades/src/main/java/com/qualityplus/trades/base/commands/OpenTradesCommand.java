...
@Component
public final class OpenTradesCommand extends AssistantCommand {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        return openInventory(args, sender, new TradesGUI(box, player.getUniqueId(), 1), syntaxMsg, mustBeAPlayer, invalidPlayer);
    }
